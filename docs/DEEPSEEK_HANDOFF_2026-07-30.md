...
- yumu-image：  
  `G:\My pack\Agent Work\codex_work\napcat-local-bots\sources\yumu-image\src\panel\panel_A4.js`
- yumu-bot：  
  `G:\My pack\Agent Work\codex_work\napcat-local-bots\sources\yumu-bot\src\main\java\com\now\nowbot\service\messageServiceImpl\BPService.kt`
...
`G:\QQ-AI-ChatBot\data\yumu-renders\bp-direct-verify-env.webp`
...
`G:\QQ-AI-ChatBot\data\yumu-renders\bp-direct-verify-init.webp`
...
```powershell
Set-Location -LiteralPath 'G:\QQ-AI-ChatBot'
```
...
```text
[CQ:at,qq=3861208813] 调用雨沐把我的 BP list 展示出来
[CQ:at,qq=3861208813] 看看我 BP1
```

使用一个假的测试群号，例如 `9999999999`，用户号使用已绑定账号的 `570341031`。
