    ...
    <div className="groups-workspace">
      ...
      <div className="groups-detail-panel">
        ...
        {!creating && selectedGroup && <>
          ...
          <Card className="groups-danger-zone"><SectionHeader title="数据操作" description="这些操作会清理或永久删除已有数据。" /><div><Button variant="danger-ghost" icon={RefreshCw} onClick={() => openConfirmation('clear-context')}>清空群上下文</Button><Button variant="danger" icon={Trash2} onClick={() => openConfirmation('delete-group')}>删除群及关联数据</Button></div></Card>
        </>}
      </div>
    </div>
