...
try {
  ...
  assert.match(direct.content, /实验性 V0\.9/);
  ...
  assert.equal(direct.metadata.actualExecutor, 'osu_skill_profiler_v09');
  ...
  assert.equal(envelope.evidence.metadata.actualExecutor, 'osu_skill_profiler_v09');
