...
/w skill recent [玩家名或 p:[玩家ID]] · 最近 50 条起步，最多回溯 5 天，生成近期发挥与 BP50 参考画像
/w skill compare <玩家A> <玩家B> · 空格分隔；玩家名含空格时用 p:[玩家ID]
/w skill <BP名次或BID> [+Mods] · 指定玩家：<玩家名> <BP名次>；玩家 ID 用 p:[玩家ID]
