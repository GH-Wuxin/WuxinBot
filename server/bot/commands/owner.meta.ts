...
export const OWNER_COMMANDS: OwnerCommandMeta[] = [
  ...
  { id: 'skill', commandPath: '/skill', group: 'osu!', syntax: '/w skill profile [玩家名或 p:[完整玩家名或ID]]；recent [玩家名或 p:[完整玩家名或ID]]；compare <玩家A> <玩家B>（空格/方括号名用 p:[完整玩家名或ID]）；<BP名次或BID> [+Mods]；<玩家名或 p:[完整玩家名或ID]> <BP名次>', description: '生成 BP50 长期画像、最近五天发挥画像、玩家对比图，或分析单张 BP/BID', permissionKey: 'skill', ...P('skill'), status: 'active', execution: { kind: 'local', handlerKey: 'skill' }, implementationRefs: [{ path: 'server/bot/owner/skill.ts', symbol: 'ownerSkillHandler' }] },
