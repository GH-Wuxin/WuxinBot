...
export const OWNER_COMMANDS: OwnerCommandMeta[] = [
  ...
  { id: 'skill', commandPath: '/skill', group: 'osu!', syntax: '/w skill profile [玩家名] | compare <玩家A> | <玩家B> | <BP名次或BID> [+Mods] | <玩家名> <BP名次>', description: '生成成绩修正后的 BP50 玩家画像/对比图，或分析单张 BP/BID；纯数字玩家名可用 p:[...]', permissionKey: 'skill', ...P('skill'), status: 'active', execution: { kind: 'local', handlerKey: 'skill' }, implementationRefs: [{ path: 'server/bot/owner/skill.ts', symbol: 'ownerSkillHandler' }] },
