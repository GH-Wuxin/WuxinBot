...
export const OWNER_PERMISSION_POLICY: Record<string, OwnerPermissionPolicy> = {
  ...
  info: { defaultPermissionRole: 'guest', permission: 'all', visibility: 'public', discoverability: 'listed' },
...
export const OWNER_COMMANDS: OwnerCommandMeta[] = [
  ...
  { id: 'mode', commandPath: '/mode', group: '群聊设置', syntax: '/w mode silent|mention|light|natural|osu', description: '设置群回复模式；osu 为仅 osu! 指令', permissionKey: 'mode', ...P('mode'), status: 'active', execution: { kind: 'local', handlerKey: 'mode' }, implementationRefs: [{ path: 'server/bot/ownerCommands.ts', symbol: 'runOwnerCommand' }] },
  ...
  { id: 'osuAnalyze', commandPath: '/osu', group: 'osu!', syntax: '/w osu analyze [用户名]', description: '生成基于 BP、Recent 与 PP+ 证据的 LLM 玩家分析', permissionKey: 'osuAnalyze', ...P('osuAnalyze'), visibility: 'public', discoverability: 'listed', status: 'active', execution: { kind: 'local', handlerKey: 'osu.analyze' }, implementationRefs: [{ path: 'server/osu/commands.ts', symbol: 'handleOsuCommand' }] },
  { id: 'info', commandPath: '/info', group: 'osu!', syntax: '/w info [玩家名或 p:[完整玩家名或ID]]', description: '生成基于 BP50 的 Skill Profiler 玩家画像', permissionKey: 'info', ...P('info'), status: 'active', execution: { kind: 'local', handlerKey: 'info' }, implementationRefs: [{ path: 'server/bot/owner/skill.ts', symbol: 'ownerInfoHandler' }] },
  { id: 'skill', commandPath: '/skill', group: 'osu!', syntax: '/w skill recent [玩家名或 p:[完整玩家名或ID]]；compare <玩家A> <玩家B>（空格/方括号名用 p:[完整玩家名或ID]）；<BP名次或BID> [+Mods]；<玩家名或 p:[完整玩家名或ID]> <BP名次>', description: '生成最近五天发挥画像、玩家对比图，或分析单张 BP/BID', permissionKey: 'skill', ...P('skill'), status: 'active', execution: { kind: 'local', handlerKey: 'skill' }, implementationRefs: [{ path: 'server/bot/owner/skill.ts', symbol: 'ownerSkillHandler' }] },
