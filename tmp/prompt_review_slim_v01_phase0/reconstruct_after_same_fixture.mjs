...
const outDir = path.join(root, 'tmp', 'prompt_review_slim_v01_phase0');
fs.mkdirSync(outDir, { recursive: true });
fs.writeFileSync(path.join(outDir, 'prompt_reconstruction_after_same_fixture.json'), JSON.stringify(result, null, 2), 'utf8');
